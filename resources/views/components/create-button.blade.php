...
<merge href="{{ $href }}" {{$attributes->merge(['class' => 'inline-flex items-center px-4 py-2
...
dark:focus:bg-white active:bg-gray-300 dark:active:bg-gray-300 focus:outline-none focus:ring-2
focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out
duration-150'])}}>Create</a>
